...
/*
 *
 * https://github.com/eugenp/tutorials/blob/master/spring-boot-modules/spring-boot-deployment/src/main/java/com/baeldung/springbootnonwebapp/SpringBootConsoleApplication.java
 */

/**
 * 1. Act as main class for spring boot application
 * 2. Also implements CommandLineRunner, so that code within run method
 * is executed before application startup but after all beans are effectively
 * created
 * 
 * @author hemant
 *
